...
- Keep object lookup borrows out of callbacks and awaits; destroy collected objects outside store borrows.
- Reject wrong-shard object IDs and retain objects while local Rc references are live.
- Make weak handles weak with respect to event sets as well as objects.
...
- The From conversion requires a Send object; use a factory for non-Send objects.
